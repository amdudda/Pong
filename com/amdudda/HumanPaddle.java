...
public class HumanPaddle extends Paddle {
    ...
    static int PaddleMaxSpeed = 5;   //This doesn't quite do the same thing as in ComputerPaddle... this is how many pixels human moves per key press TODO use this in a better way
